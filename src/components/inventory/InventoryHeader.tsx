...
import { Search, Upload, Download, Edit2, Package2 } from "lucide-react";
...
export const InventoryHeader = ({ onSearch, searchTerm, selectedItems }: InventoryHeaderProps) => {
      ...
      <div className="flex flex-col md:flex-row justify-between gap-4">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          {selectedItems.length > 0 ? (
            <Link to={`/inventory/bulk-edit?items=${selectedItems.join(',')}`} className="flex-1 md:flex-none">
